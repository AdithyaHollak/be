  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: Center(
          ...
          const Text(
              " I am ADITHYA HOLLA K . We are 10 members in my family including me. I am native to Kundapur."
              " Currently , I am purusing 3rd year at NMAMIT "
              "and my graduation is about to complete in next couple of years."
              "My strengths are my analytical approach, my appreciable communication,and"
              " presentation skills. "
